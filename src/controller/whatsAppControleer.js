...
export class whatsAppControleer{
    ...
    initEvents(){
        ...
        this.el.inputSearchContacts.on('keyup', e=>{
            ...
            if(!this.el.inputSearchContacts.value.length > 0){
              ...
              this.el.inputSearchContacts.value = '';
            }else{
        ...
        this.el.formPanelAddContact.on('submit', e=>{
            ...
            contact.on('datachange', data=>{
                ...
                if (data.name){
                    console.log(Chat.createifNotExists.chats)
        ...
        this.el.btnSendPicture.on('click', e=>{
            ...
            picture.onload = e =>{
                ...
                context.scrale(-1, 1);
                context.drawnImage(picture, 0,0, canvas.width, canvas.height);
        ...
        this.el.btnSendDocument.on('click', e=>{
            ...
            this.el.btnCloseDocumentPreview.click();
        });
